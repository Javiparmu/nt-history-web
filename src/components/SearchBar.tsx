  ...
  return (
    <div className='flex items-center justify-center gap-4 mt-10'>
      ...
      <search className='flex flex-col md:flex-row items-center md:items-end justify-center gap-2 md:gap-0'>
        <input value={steamId} onChange={(e) => setSteamId(e.target.value)} className='md:mt-15 text-black rounded-lg px-4 py-2' type="text" placeholder="Enter steam ID" name="search" />
